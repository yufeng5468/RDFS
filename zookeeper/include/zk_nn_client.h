 ...
 */
    ...
    public:
        ...
        /**
         * Determine whether append request is valid.
         */
        bool process_request(String &client_name, string &file_path, AppendRequestProto &req);

        /**
         * Grant primary block for a file.
         */
        bool get_primary_block_info(string &file_path, AppendRequestProto &req, AppendResponseProto &res);
