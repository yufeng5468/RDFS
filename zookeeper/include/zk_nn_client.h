...
class ZkNnClient : public ZkClientCommon {
 public:
  ...
  void get_info(GetFileInfoRequestProto &req, GetFileInfoResponseProto &res, std::string client_name);
  ...
  void destroy(DeleteRequestProto &req, DeleteResponseProto &res, std::string client_name);
  void complete(CompleteRequestProto &req, CompleteResponseProto &res, std::string client_name);
  void rename(RenameRequestProto &req, RenameResponseProto &res, std::string client_name);
  bool get_listing(GetListingRequestProto &req, GetListingResponseProto &res, std::string client_name);
  ...
  /**
       * Add block.
       */
  bool add_block(AddBlockRequestProto &req, AddBlockResponseProto &res, std::string client_name);
